...
<head>
	...
	<title>Test Part 2 - Image 1</title>
	...
	<?php
		...
		#We use the ternary operator to set a value to NULL in the mySQL table if somehow something wasn't set
		#This keeps us from running into sql errors
		...
		#Add a variable to identify which test question we are on. This will need to be stored as part of the results table
...
<!-- mySQL stuff -->
	...
	$query = 'INSERT INTO group8results (uid, selfwordcount, selftime, q1, q2, q3, q4, q5, photoid, timedelta, similarity_score, wordcount) VALUES (' . $uid . ', ' . $selfwordcount . ', ' . $selftime .  ', ' . $q1 .  ', ' . $q2 .  ', ' . $q3 .  ', ' . $q4 .  ', ' . $q5 .  ', ' . $lastpersonid .  ', ' . $timedelta .  ', ' . $lastsimilarity .  ', ' . $lastwordcount . ')';
	$mysqli->query($query);
...
<body>
	...
	<main>
		...
		<img src="images/Jace-Boyd.png">
		<form method="POST" action="test-5.php">
			...
			<p><i>An unarmed panhandler was shot outside a Trader Joe's</i><br />
